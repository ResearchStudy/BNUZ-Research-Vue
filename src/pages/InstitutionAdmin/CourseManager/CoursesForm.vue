<template>
  <div style="padding: 50px">
    <div style="width: 80%;margin-left: 10%">
      <div>
        <h1 style="font-size:25px" align="center">发布课程</h1>
        <el-divider></el-divider>
      </div>
        <el-form :model="form" ref="form" label-width="100px">
          <el-form-item label="课程名称">
            <el-input style="width:820px" v-model="form.title"></el-input>
          </el-form-item>
          <el-form-item label="课程子标题">
            <el-input style="width:820px" v-model="form.subtitle"></el-input>
          </el-form-item>
          <el-row>
            <el-col span="280">
              <el-form-item label="适合人群">
                <el-input style="width:500px" v-model="form.suitable_for_crowd"></el-input>
              </el-form-item>
            </el-col>
            <el-col span="50">
          ...
          <el-form-item label="课程标签">
            <el-select style="width:820px" v-model="form.tag" multiple placeholder="请选择课程类型">
          ...
          <el-row>
            <el-col span = "10">
              <el-form-item style="width:120px" label="课程时间">
                <el-date-picker
                        v-model="form.date"
                        type="daterange"
                        unlink-panels
            ...
            <el-col :span="6">
              <el-form-item label="省份">
                <el-select style="width:190px" v-model="form.address.province_id" placeholder="请选择省份"
            ...
            <el-col :span="6">
              <el-form-item label="城市">
                <el-select style="width:190px" v-model="form.address.city_id" placeholder="请选择城市">
