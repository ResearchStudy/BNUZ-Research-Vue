      ...
      <div class="search-group" style="border: 1px solid #f2f2f2;padding: 15px 30px; background: #F6F6F8" >
        <div style="width: 100%;margin-left:2%">
          ...
          <div style="display: inline-flex; align-items: center">
            ...
            <el-select v-model="country_id" placeholder="国家" @change="getProvinceList" style="margin-right: 20px;width:140px">
              <el-option
            ...
            <el-select v-model="province_id" placeholder="省份" style="padding-left: 10px;margin-right: 20px;width:155px" @change="getCityList">
              <el-option
            ...
            <el-select v-model="city_id" placeholder="城市" style="padding-left: 10px;margin-right: 20px;width:155px">
              <el-option
